...
class User {
  ...
  static async authenticate(identifier, password) {
    try {
      ...
      // Verificación de usuario removida - todos los usuarios activos pueden acceder
  ...
  static async create(userData) {
    try {
      ...
      const sql = `
        INSERT INTO users (id, username, email, password_hash, first_name, last_name, phone, avatar_url, is_active, is_verified, created_at, updated_at)
