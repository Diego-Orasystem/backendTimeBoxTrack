...
class User {
  ...
  /**
   * Autenticar usuario con username/email y contraseÃ±a
   */
  static async authenticate(identifier, password) {
    try {
      ...
      const sql = `
        ...
        FROM users u
        LEFT JOIN user_roles ur ON u.id = ur.user_id AND 
  ...
  static async refreshAccessToken(refreshToken) {
    try {
      ...
      if (tokens.length === 0) {
        return { success: false, message: 'Token de refresh invÃ¡lido o expirado' };
      }
  ...
  /**
   * Cerrar sesiÃ³n (revocar todos los tokens del usuario)
   */
  ...
  static async getUserPermissions(userId, options = {}) {
    try {
      ...
      // Convertir a formato mÃ¡s Ãºtil
      const permissionMap = {};
  ...
  /**
   * Crear token de reseteo de contraseÃ±a
   */
  ...
  static async updateLastLogin(userId) {
    try {
      ...
      console.error('Error al actualizar Ãºltimo login:', error);
    }
  }
  ...
  // =====================================================
  // MÃ‰TODOS PARA ADMINISTRACIÃ“N DE USUARIOS
  // =====================================================

  /**
   * MÃ©todo para asignar rol a un usuario (versiÃ³n simplificada para admin)
   */
  ...
  /**
   * MÃ©todo para actualizar rol de un usuario
   */
  ...
  /**
   * MÃ©todo para actualizar usuario (versiÃ³n para admin)
   */
  ...
  /**
   * MÃ©todo para eliminar usuario (hard delete para admin)
   */
  ...
  /**
   * MÃ©todo para obtener usuario con roles (versiÃ³n para admin)
   */
  ...
  /**
   * MÃ©todo para obtener todos los usuarios con roles (versiÃ³n para admin)
   */
