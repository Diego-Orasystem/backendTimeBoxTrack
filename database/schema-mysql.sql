-- Esquema compatible con MySQL para PlanetScale
-- Crear base de datos (no necesario en PlanetScale, ya se crea automáticamente)
...
CREATE TABLE IF NOT EXISTS timeboxes (
    ...
    monto DECIMAL(15,2),
    estado ENUM('En Definición', 'Disponible', 'En Ejecución', 'Finalizado') DEFAULT 'En Definición',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
